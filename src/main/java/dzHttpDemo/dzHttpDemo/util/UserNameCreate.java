...
public class UserNameCreate {
	...
	public static String getRomdomhz() {
		String[] aStrings= {"暮子","旷度","求配","累","鸟毳","斋宇","泛","沙锅","漏","蛉","宪","骨","鹏壑","鱼筒","安安蓝","法义","波荡","况复","洛洛","深堑","鯹咸","黑吃黑","暴落","沴魃","泥人","治兵","洪筭","洞溃","活的儿","消任","海屋筹添","暴腾","畅是","扬","龙殿","颓淡","显家",
...
//		int max=aStrings.length;
		int max=2959;
        int min=1;
//		String[] bStrings=aStrings;
    ...
    public static String getUserName() {
		...
		Random random = new Random();
        int s = random.nextInt(max)%(max-min+1) + min;
        String uString=getRomdomhz()+getStringRandom(s);
        return uString;
