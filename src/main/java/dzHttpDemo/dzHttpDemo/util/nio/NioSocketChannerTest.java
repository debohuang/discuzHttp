package dzHttpDemo.dzHttpDemo.util.nio;
...
public class NioSocketChannerTest {
	
	private static byte[] request = null;

    static {
        StringBuffer temp = new StringBuffer();
        temp.append("GET http://localhost:18086/forum.php HTTP/1.1\r\n");
        temp.append("Host: 127.0.0.1:18086\r\n");
    ...
    public static void sendHttpRequest() throws Exception {
        try {
        	//使用代理
            final SocketChannel socketChannel = SocketChannel.open(new InetSocketAddress("localhost", 28080));
            ...
            System.out.println("-------net read end--------");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) throws Exception {
    	NioSocketChannerTest nioSocketChannerTest=new NioSocketChannerTest();
//        sendHttpRequest();
    }
